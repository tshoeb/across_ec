...
Registrar.create(first_name: 'Zuhair', last_name: 'G', phone: '77155015', email: 'zzg@qatar.cmu.edu', university_id: 1, admin: false, password: 'hello', password_confirmation: 'hello')