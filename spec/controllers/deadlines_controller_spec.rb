  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved deadline as @deadline" do
        ...
        post :create, {:deadline => { "semester" => "invalid value" }}, valid_session
        assigns(:deadline).should be_a_new(Deadline)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested deadline" do
        ...
        Deadline.any_instance.should_receive(:update_attributes).with({ "semester" => "MyString" })
        put :update, {:id => deadline.to_param, :deadline => { "semester" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the deadline as @deadline" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Deadline.any_instance.stub(:save).and_return(false)
        put :update, {:id => deadline.to_param, :deadline => { "semester" => "invalid value" }}, valid_session
        assigns(:deadline).should eq(deadline)
      end
